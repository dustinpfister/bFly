 ...
 /*
	 ...
	 all functions here should be modular and reusable, no spaghetti code allowed here.
  
     I guess I should be using requestAnimFrame(func)  in place of vat t=setTimeout(func,1000/frameRate),
	 becuase of this:
