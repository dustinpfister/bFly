	...
	var render={ 
		 ...
		 menu:function(){
			...
			if(i!=state.maxMenuFlowers){  // if the max flowers have not yet been reached
				 ...
				 //var str=tb.breakToLines('Use the W,A,D keys, or touch screen, to move Mr BtterFly. Try your best to keep your nectar bar from fully depleting, by gathering Nectar from flowers. As time goes by your luck will change. ',12,400);
				 tb.printStringArrayToContext(state.menuMessage,con,12,325,300);
				// con.fillText('Use the W,A,D keys, or touch, to move Mr BtterFly. Try your best to keep your nectar bar from fully depleting, by gating Nectar from flowers. ', 250,250)
